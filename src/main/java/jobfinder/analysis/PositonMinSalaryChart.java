...
public class PositonMinSalaryChart extends ApplicationFrame {

    private static final long serialVersionUID = 4546147160777122216L;

    Map<String, Long[]> jobData;

    public PositonMinSalaryChart(String s, Map<String, Long[]> jobData) {
        super(s);
    ...
    private JFreeChart createChart(DefaultCategoryDataset linedataset) {
        ...
        JFreeChart chart = ChartFactory.createBarChart("职位平均最低工资", "", "工资额度", linedataset, PlotOrientation.VERTICAL, true, true,
                false);
    ...
    private DefaultCategoryDataset createDataSet() {
        ...
        for (Entry<String, Long[]> data : jobData.entrySet()) {
            ...
            linedataset.addValue(typeData[1], series, data.getKey());
        }
